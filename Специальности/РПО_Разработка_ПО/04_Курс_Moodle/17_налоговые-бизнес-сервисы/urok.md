...
Для ИТ-специалистов есть льготные режимы (например, для участников IT-парков) — детали меняются, поэтому всегда проверяй актуальные условия на официальных ресурсах.
