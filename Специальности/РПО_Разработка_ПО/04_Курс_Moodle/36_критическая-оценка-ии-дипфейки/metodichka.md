...
### 4.7. Почему это профессиональная ответственность разработчика
...
- Дипфейк — поддельные фото/видео/аудио; признаки: детали изображения, рассинхрон губ и звука, источник, сенсационность.
