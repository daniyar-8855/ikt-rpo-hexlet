...
## Занятие 24. Интерактивные формы и совместная работа

---

**Дисциплина:** Применение информационно-коммуникационных и цифровых технологий
**Результат обучения:** РО 2.2 — работа с веб-сервисами и совместная работа · **Объём темы:** 2 часа
...
**Пример 2 — регистрация на хакатон и приватность.** Нужно записать одногруппников на хакатон. Поля: ФИО (текст), e-mail (текст с проверкой формата), команда (текст), телефон (текст), готовность к ночному кодингу (шкала 1–5). *Разбор:* ИИН, адрес и размер обуви не добавляем — они не нужны для задачи (минимизация данных, [3]). В начале формы пишем цель: «данные нужны для организации хакатона и связи с участниками». Тип e-mail с проверкой отсекает опечатки в адресах ещё на входе. Шкала готовности позже позволит сравнить участников числом.
