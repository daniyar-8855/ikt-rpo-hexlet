...
> **Памятка.** Запрос на анализ данных собери по модели **5S** (занятие 27): роль («Ты аналитик данных») → конкретика с примером (обезличенные показатели + контекст) → простой язык → формат ответа (3 вывода или таблица) → уточнение в диалоге.
