...
## Занятие 23. Электронные платежи и онлайн-банкинг

---

**Дисциплина:** Применение информационно-коммуникационных и цифровых технологий
**Результат обучения:** РО 2.2 — уверенная работа с цифровыми сервисами и порталами · **Объём темы:** 2 часа
...
- **Платёжная система** — посредник между банком плательщика и банком получателя (Visa, Mastercard, в РК также «Тенге Card»).
