...
Дело в том, что часть деятельности нельзя вести «просто так»: на рисковые виды государство требует лицензию или разрешение. Разработчик натыкается на это с двух сторон: когда делает продукт для регулируемой сферы (медицина, финансы, образование) и когда сам открывает своё дело — ИП, стартап, студию. Пример из жизни: заказчик просит приложение для аптеки с онлайн-продажей лекарств и спрашивает, нужна ли лицензия и кому её оформлять. Ответишь наугад — подведёшь клиента или потеряешь заказ; ответишь по делу — станешь тем разработчиком, к которому возвращаются. И там, и там выручает один навык: открыть портал **eLicense.kz** и разобраться, что лицензируется, а что нет.
