...
Чтобы такие проблемы не съедали часы, технику информационных систем нужно понимать, на чём и где выполняется программа — и на его рабочем месте, и на компьютере пользователя, и на сервере. Любая программа работает не в пустоте: под ней — слои аппаратного обеспечения, операционной системы и файловой системы. Посмотри на эти слои.

![Слои компьютерной системы: железо, ОС, прикладное ПО](assets/02_shema-sloi-sistemy.svg)

## Что ты научишься делать

- объяснять, какие компоненты ПК влияют на подбор рабочего места, скорость разработки и запуска программ;
- описывать, что делает операционная система, и зачем технику информационных систем Linux;
...
Связь с профессией: техник информационных систем ежедневно работает в терминале, готовит рабочие места и серверы, ставит и настраивает окружение и ПО, разворачивает системы и код на серверах под управлением Linux. Умение выбрать компьютер под задачи, читать пути и держать структуру проекта и файлов в порядке отличает того, у кого «просто работает», от того, кто постоянно борется с настройкой.
...
## Из чего состоит компьютер (и что важно технику информационных систем)
...
Вывод: для рабочего места техника и разработки критичнее всего **RAM и SSD**, а не «самый мощный процессор».
...
- **Linux** — на нём работает большинство серверов в мире. Технику информационных систем важно уметь в нём ориентироваться: на Linux работают серверы, которые ты настраиваешь и сопровождаешь, и туда «уезжает» твой код в продакшене.

Знать обе ОС — норма для техника информационных систем. Часто на Windows ставят Linux-окружение (WSL, контейнеры), чтобы среда совпадала с сервером и не возникало ошибок «работает только у меня».
...
В одном абзаце реши для себя: если завтра тебе поручат подобрать рабочую станцию под задачи техника (веб-разработка с несколькими контейнерами, настройка ПО, работа с базой данных) — что ты возьмёшь в приоритет, RAM+SSD или топовый процессор, и почему. Привяжи ответ к своему заданию 1–3 (много ли у тебя будет одновременно открытых инструментов).
...
- Я умею объяснить, какие компоненты ПК важны для рабочего места и разработки и почему.
- Я знаю, что делает ОС, и понимаю, зачем технику информационных систем Linux.
