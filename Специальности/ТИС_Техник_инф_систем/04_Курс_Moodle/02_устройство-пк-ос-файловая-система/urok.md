...
- описывать, что делает операционная система, и зачем технику ИС Linux;
...
## Из чего состоит компьютер (и что важно технику ИС)
...
- **Linux** — на нём работает большинство серверов в мире. Технику ИС важно уметь в нём ориентироваться: на Linux работают серверы, которые ты настраиваешь и сопровождаешь, и туда «уезжает» твой код в продакшене.

Знать обе ОС — норма для техника ИС. Часто на Windows ставят Linux-окружение (WSL, контейнеры), чтобы среда совпадала с сервером и не возникало ошибок «работает только у меня».
...
- Я знаю, что делает ОС, и понимаю, зачем технику ИС Linux.
