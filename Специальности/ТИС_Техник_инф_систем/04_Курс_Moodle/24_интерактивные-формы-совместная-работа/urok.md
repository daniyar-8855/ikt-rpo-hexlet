...
А можно иначе: за пять минут собрать онлайн-форму, раздать одну ссылку — и ответы 30 человек сами лягут в аккуратную таблицу, в едином формате, без потерь и дублей. Тебе как технику информационных систем такие сервисы нужны вдвойне: и чтобы работать в команде, и чтобы налаживать приём заявок пользователей — например, собирать обращения в техподдержку через одну форму, а не вылавливать их из чата и звонков.
