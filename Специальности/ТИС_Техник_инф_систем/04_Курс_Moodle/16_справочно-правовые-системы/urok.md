...
Ты сопровождаешь информационную систему организации, и приходит задача: убедиться, что персональные данные пользователей хранятся так, как требует закон. Ты гуглишь «как хранить персональные данные» — и первая же ссылка ведёт на статью-инструкцию с чужого сайта, написанную несколько лет назад. Половина требований там уже устарела: закон с тех пор редактировали. Настроишь защиту по этой устаревшей копии — формально нарушишь норму и подставишь под проверку и себя, и организацию. Найдёшь действующую редакцию требования в официальном источнике — настроишь правильно и сможешь показать, на какую статью опираешься.

«А это вообще законно?» — этот вопрос у техника информационных систем всплывает постоянно: можно ли так хранить персональные данные пользователей сопровождаемой системы, нужна ли лицензия на используемое ПО, как оформить самозанятость или ИП. Ответ всегда записан в законах — вопрос лишь в том, найдёшь ли ты действующую редакцию, а не случайную копию с чужого сайта. Для этого и нужны справочно-правовые системы: они дают официальный первоисточник с актуальной датой, а не пересказ из чата или блога 2014 года, где закон мог с тех пор десять раз измениться. Умение открыть первоисточник и прочитать конкретную статью отличает профессионала от того, кто верит слухам.
...
Связь с профессией: технику ИС регулярно нужно проверять правовые требования — к обработке персональных данных пользователей, к информатизации, к лицензиям на внедряемое и сопровождаемое ПО, к условиям договора с заказчиком. Чтобы законно внедрять и сопровождать автоматизированные информационные системы организации, настраивать защиту данных и консультировать пользователей, нужно опираться на действующие законы. Ссылка на конкретную статью действующего закона делает твою позицию весомой в споре с заказчиком, коллегой или проверяющим.
...
- почему поиск на схеме заканчивается не просто «найденным законом», а конкретной статьёй или пунктом?
...
Чтобы сослаться точно, достаточно знать устройство акта: **акт → главы/разделы → статьи → пункты**, от общего к частному. Корректная ссылка указывает не «где-то в законе», а конкретную статью и пункт.
