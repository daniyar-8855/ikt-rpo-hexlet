...
Связь с профессией: техник ИС отвечает за то, чтобы система с ИИ, которую он настраивает и сопровождает, соответствовала законодательству — особенно при работе с персональными данными пользователей. Это часть профессиональной ответственности, а не «дело юристов».
...
- ИИ — инструмент: ответственность за результат несёт человек/организация, а техник ИС отвечает за соответствие системы, которую он сопровождает, закону.
