...
С начала 2026 года в Казахстане действует профильный **Закон «Об искусственном интеллекте»**. Вместе с ним применение ИИ регулируют смежные законы — о персональных данных и об информатизации. Техник информационных систем обязан понимать, что требует каждый из них: именно он отвечает за то, чтобы система с ИИ, которую он настраивает и сопровождает, не нарушала эти нормы. Точные номера и даты законов запоминать наизусть не нужно — их всегда можно сверить на adilet.zan.kz; важнее понимать смысл и практические последствия каждой нормы.
...
Связь с профессией: техник информационных систем отвечает за то, чтобы система с ИИ, которую он настраивает и сопровождает, соответствовала законодательству — особенно при работе с персональными данными пользователей. Это часть профессиональной ответственности, а не «дело юристов».
...
- ИИ — инструмент: ответственность за результат несёт человек/организация, а техник информационных систем отвечает за соответствие системы, которую он сопровождает, закону.
