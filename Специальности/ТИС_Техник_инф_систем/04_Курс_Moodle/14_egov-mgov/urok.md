...
Связь с профессией: eGov.kz и eGov Mobile — это работающий пример большой информационной системы с идентификацией пользователя, электронной подписью, каталогом услуг и личным кабинетом. Технику информационных систем полезно видеть изнутри логику таких сервисов: как пользователь входит, как подтверждает действие, где хранится результат. Эти же принципы ты будешь применять, когда сопровождаешь АИС организаций, интегрированные с eGov и платёжными системами, и помогаешь пользователям с порталами и ЭЦП (ПМ 7).
...
- Как техник информационных систем, какие меры защиты ты бы заложил в систему входа и подписи, чтобы у пользователей не крали ЭЦП?
