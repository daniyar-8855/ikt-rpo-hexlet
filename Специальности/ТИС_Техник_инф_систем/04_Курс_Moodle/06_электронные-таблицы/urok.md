...
- Почему технику информационных систем бывает быстрее проверить данные (логи, метрики, реестр заявок) в таблице, чем сразу писать для этого код?
