...
Связь с профессией: техник ИС всё чаще консультирует заказчика на старте — нужна ли его деятельности лицензия, кто её получает, какие требования к ПО и к информационной системе в регулируемой сфере. Это часть профессиональной грамотности, которая отличает специалиста от исполнителя «по ТЗ».
...
### Мини-кейс
Команда делает приложение для аптек с функцией продаж. Возникает вопрос: нужна ли лицензия фармдеятельности? Следующий шаг: проверить на eLicense.kz перечень лицензируемых видов и уточнить, что лицензируется именно **деятельность аптеки (клиента)**, а требования к ПО — отдельно. Так техник ИС сразу даёт заказчику корректный ответ.
