...
Представь: вы с друзьями решили запустить свой стартап — маленькую онлайн-школу программирования для школьников. Придумали название, сверстали лендинг, готовы брать оплату. И тут всплывает вопрос: «А образовательную деятельность разве можно вести без лицензии? Куда за ней идти — стоять в очередях по кабинетам?» Ещё десять лет назад это были бы недели беготни с бумагами. Сегодня лицензию и разрешения оформляют онлайн, из дома, через один портал — eLicense.kz.

Дело в том, что часть деятельности нельзя вести «просто так»: на рисковые виды государство требует лицензию или разрешение. Техник информационных систем натыкается на это с двух сторон: когда внедряет или разрабатывает продукт для регулируемой сферы (медицина, финансы, образование) и когда сам открывает своё дело — ИП, стартап, студию. Пример из жизни: заказчик просит приложение для аптеки с онлайн-продажей лекарств и спрашивает, нужна ли лицензия и кому её оформлять. Ответишь наугад — подведёшь клиента или потеряешь заказ; ответишь по делу — станешь тем специалистом, к которому возвращаются. И там, и там выручает один навык: открыть портал **eLicense.kz** и разобраться, что лицензируется, а что нет.
...
Связь с профессией: техник информационных систем всё чаще консультирует заказчика на старте — нужна ли его деятельности лицензия, кто её получает, какие требования к ПО и к информационной системе в регулируемой сфере. Это часть профессиональной грамотности, которая отличает специалиста от исполнителя «по ТЗ».
...
### Мини-кейс
Команда делает приложение для аптек с функцией продаж. Возникает вопрос: нужна ли лицензия фармдеятельности? Следующий шаг: проверить на eLicense.kz перечень лицензируемых видов и уточнить, что лицензируется именно **деятельность аптеки (клиента)**, а требования к ПО — отдельно. Так техник информационных систем сразу даёт заказчику корректный ответ.
