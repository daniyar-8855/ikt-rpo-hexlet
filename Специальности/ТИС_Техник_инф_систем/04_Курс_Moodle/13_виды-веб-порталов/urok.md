...
Связь с профессией: техник информационных систем постоянно работает с веб-сервисами и порталами — и как пользователь, и как тот, кто их настраивает, сопровождает и участвует в их разработке. Понимая, чем информационный портал отличается от интерактивного, ты будешь грамотнее проектировать и обслуживать интерфейсы, формы входа и сценарии, где у действия есть последствия (платёж, отправка заявки).
