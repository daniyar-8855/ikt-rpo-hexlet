...
До сих пор мы защищали **твои** данные — это понятно и близко. Но как будущий техник ИС ты постоянно работаешь и с **чужими** данными — данными пользователей, которых обслуживаешь: они в базах, в заявках, в резервных копиях, в логах. И здесь к твоим привычкам добавляется ещё и закон, который спрашивает строго.
