...
Связь с профессией: техник ИС защищает результат своей работы постоянно — обосновывает выбор сервера, ПО или облачного сервиса перед руководителем, показывает заказчику итог внедрения АИС, отчитывается о закрытых заявках, решённых инцидентах и обслуживании сети. Тот, кто умеет за несколько слайдов объяснить «какую проблему решили и как», ценится в команде выше, чем тот, кто хорошо настроил систему или написал код, но связно рассказать о результате не может.
...
- Где ещё в работе техника ИС пригодится умение коротко показать результат (отчёт о внедрении АИС, доклад по закрытым заявкам, обоснование выбора сервера или ПО перед руководителем)?
