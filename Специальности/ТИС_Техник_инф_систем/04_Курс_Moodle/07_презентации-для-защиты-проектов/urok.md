...
Презентация — это не «слайды ради слайдов», а инструмент, который помогает донести идею за короткое время. Технику информационных систем она нужна постоянно: защита учебного или дипломного проекта, отчёт о внедрении и настройке АИС перед заказчиком, доклад о закрытых заявках и решённых инцидентах, обоснование выбора сервера, ПО или облачного решения перед руководителем. Этот урок — как собрать презентацию, которая работает на тебя.
...
Связь с профессией: техник информационных систем защищает результат своей работы постоянно — обосновывает выбор сервера, ПО или облачного сервиса перед руководителем, показывает заказчику итог внедрения АИС, отчитывается о закрытых заявках, решённых инцидентах и обслуживании сети. Тот, кто умеет за несколько слайдов объяснить «какую проблему решили и как», ценится в команде выше, чем тот, кто хорошо настроил систему или написал код, но связно рассказать о результате не может.
...
- Где ещё в работе техника информационных систем пригодится умение коротко показать результат (отчёт о внедрении АИС, доклад по закрытым заявкам, обоснование выбора сервера или ПО перед руководителем)?
