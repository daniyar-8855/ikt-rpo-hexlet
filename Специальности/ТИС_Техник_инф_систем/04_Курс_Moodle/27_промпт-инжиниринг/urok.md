...
Те же четыре части работают и для скриптов администрирования — второй половины работы техника ИС. Промпт «Ты системный администратор. Напиши на Bash скрипт резервного копирования каталога `/var/www` в архив с датой в имени; учти пустой каталог; дай код и одну строку пояснения» задаёт роль, задачу, контекст и формат так же чётко, как промпт для функции на Python, — и черновик скрипта приходит почти готовым.
