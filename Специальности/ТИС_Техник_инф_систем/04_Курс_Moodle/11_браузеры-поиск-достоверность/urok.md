...
Связь с профессией: техник информационных систем ежедневно ищет: как исправить ошибку в коде, как настроить сервис, что означает сообщение в логе, какой подход выбрать. Умение **сформулировать запрос и оценить источник** — это часть профессионального навыка работы с информацией, без которого не обойтись ни на учёбе, ни на работе.
...
> Для техника информационных систем лучший источник — **официальная документация** (Python, MDN, Microsoft). Stack Overflow полезен, но проверяй дату ответа и количество голосов.
...
**Образец (часть ответа на пункт 1):** «`"ModuleNotFoundError: No module named pandas" python site:stackoverflow.com` — взял точный текст ошибки в кавычки, указал язык, ограничил поиск по сайту с ответами техник информационных системов».
...
- Почему для техника информационных систем «понять чужой код перед вставкой» важнее, чем «найти готовое решение быстрее»?
