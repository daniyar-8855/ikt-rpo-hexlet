...
Обрати внимание: этот запрос собран по модели 5S (занятие 27) — роль и инструмент, конкретика с примером данных, простой язык, нужный формат (код + пояснение), а уточнение в диалоге ты дашь на этапе 5, когда проверишь результат.
