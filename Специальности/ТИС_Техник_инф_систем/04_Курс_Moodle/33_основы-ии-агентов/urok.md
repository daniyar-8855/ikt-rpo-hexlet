...
Связь с профессией: технику информационных систем всё чаще нужно не просто писать код, а **собирать и настраивать агентов** — давать им инструменты, ограничивать права, проверять результат. Это новый и востребованный навык, особенно в сопровождении систем: агенту можно поручить разбор заявок техподдержки и мониторинг доступности сервисов (ПМ 7).
...
Ещё пример — из работы техника информационных систем в сопровождении АИС. Агент **разбирает заявки техподдержки**: читает новое обращение, определяет категорию, находит похожие уже решённые заявки и предлагает ответ. Или **мониторит доступность сервиса**: периодически проверяет, отвечает ли система, и при сбое присылает уведомление дежурному. И здесь человек остаётся в контуре — закрытие заявки и любые действия на рабочем сервере подтверждает техник.
