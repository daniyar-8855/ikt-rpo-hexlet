...
- видеть связь этих навыков с реальной работой техника информационных систем (код-ревью, демо, ретроспектива).
...
**Во-вторых, честность ценится выше, чем поза «я гений».** И преподаватель, и твоя будущая команда прекрасно знают, что современный техник информационных систем пользуется ИИ, — это нормальный рабочий инструмент, никого им не удивишь и не разочаруешь. Ненормально другое — не понимать, чем ты пользуешься. Поэтому фраза «здесь мне помог ИИ, и вот как я это проверил» читается как зрелость: ты владеешь инструментом, а не прячешься за ним.

**В-третьих, это и есть та самая ответственность, о которой шёл весь курс.** За код, который ты сдаёшь и защищаешь, отвечаешь ты — даже за тот фрагмент, что сгенерировал ИИ. Честно назвать роль ИИ — значит вслух признать эту ответственность, а не спихнуть её на инструмент. Именно этого от техника информационных систем и ждут.
