...
Эта тема — про навык, который на первый взгляд «не про программирование», а на деле сопровождает техника информационных систем каждый день. README и инструкция по развёртыванию, паспорт рабочего места и описание настроек оборудования и ПО, регламенты и инструкции для пользователей, описание API, техническое задание, комментарий к задаче в трекере — всё это пишет именно техник информационных систем, а не «отдельный человек по документам». И пишет не «красиво», а **структурно**: так, чтобы другой человек — или ты сам через полгода, когда забудешь детали, — понял суть за минуту, а не разбирался с нуля. Умение быстро собрать понятный технический документ напрямую влияет на то, примут ли твою работу в команде и сможет ли ею воспользоваться кто-то кроме тебя [1; 5].
...
Где техник информационных систем встречает документацию на практике — чтобы ты видел, что навык не «учебный»:
- **README** — описание проекта в корне репозитория (главный документ темы);
- **инструкция по установке / развёртыванию** — как поднять проект, рабочее место или сервер на новой машине, настроить ПО и оборудование;
...
- **комментарии к задачам** в трекере, записи в базе знаний команды (вики), changelog (история изменений); паспорт рабочего места и журнал настроек оборудования.

Всё это объединяет одно: пишет техник информационных систем, и пишет структурно. «Структурно» — это не про длину, а про то, что каждый кусок содержания лежит в правильном виде: шаги — списком, сравнение — таблицей, команда — кодом. Об этом весь следующий раздел.
...
1. **Кто читатель и зачем читает.** Прежде чем писать, ответь: для кого документ и какую задачу человек решает с его помощью. README для новичка-стажёра и описание API для опытного специалиста — разные документы по глубине и языку. Этот шаг определяет всё остальное: не поймёшь читателя — текст выйдет «для себя», а не «для того, кто будет действовать».
